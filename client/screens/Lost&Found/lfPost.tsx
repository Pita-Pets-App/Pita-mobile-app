...
<View style={{display:"flex",flexDirection:"row",marginHorizontal:20,marginVertical:10,justifyContent:"space-between"}}>
  {likers.includes(parseInt(userData.id))?
<TouchableOpacity onPress={()=>{handleDelete()}} style={{display:"flex",flexDirection:'row',alignItems:"center",gap:4}}>
  <Image style={{width:width*0.075,height:width*0.075}} source={likeact}></Image>
  <Text>{likesCount} Likes</Text>
  </TouchableOpacity>:<TouchableOpacity onPress={()=>{handleAdd()}} style={{display:"flex",flexDirection:'row',alignItems:"center",gap:4}}>
  <Image style={{width:width*0.075,height:width*0.075}} source={like}></Image>
  <Text>{likesCount} Likes</Text>
  </TouchableOpacity>}
  <TouchableOpacity onPress={()=>{navigation.navigate(...["comment",{cmnts:com,postInfo:el,upadate:Upadate()}] as never )}}  style={{display:"flex",flexDirection:'row',alignItems:"center",gap:4}}>
