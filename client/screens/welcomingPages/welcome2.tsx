    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={()=>navigation.navigate("Home")}><View style={{paddingVertical:5,paddingHorizontal:15,borderRadius:20,borderColor:"#4e9d91",borderWidth:1}}><Text style={{color: '#4e9d91',}}>Skip</Text></View></TouchableOpacity>
        <View style={{display:"flex",flexDirection:"row",gap:4}}>
            ...
            <TouchableOpacity onPress={()=>navigation.navigate("welcome3")}><View style={{backgroundColor: '#4e9d91', paddingVertical:5,paddingHorizontal:15,borderRadius:20,borderColor:"#4e9d91",borderWidth:1}}><Text style={{color: '#fff',}}>Next</Text></View></TouchableOpacity>
